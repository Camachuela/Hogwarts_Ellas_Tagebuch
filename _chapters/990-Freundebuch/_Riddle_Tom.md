...
# Äußere Erscheinung
appearance_features: '—'
appearance_behavior: 'Sehr höflich, korrekt gekleidet, „glatt“, wirkt wie ein Schauspieler; hat eine beunruhigende Intensität in den Augen.'
appearance_details: 'Jede Geste wirkt einstudiert und perfekt auswendig gelernt.'

# Charakter
char_pupils: 'Charmant, gibt vor sich für Schüler zu interessieren.'
char_facade: 'Der charmante, zukünftige Lehrer, der sich um Schüler kümmert.'
char_motives: 'Will zukünftige Schüler „kennenlernen“ (und Namen sammeln).'
char_strength: 'Charisma, Beherrschung'
char_weakness: '—'
char_sensitivity: '—'
