...
# Allgemeine Angaben
full_name: 'Sir Richard'
birth_year: '—'
death_year: '—'
char_status: 'Magisches Tierwesen'
house_slug: 'beasts'
location: '—'
estimate_danger: 'orange'

# Äußere Erscheinung
appearance_features: 'Kleines, sprechendes Wiesel, trägt einen Hut.'
appearance_behavior: 'Hochmütig, respektlos, arrogant, fordernd, flucht viel.'
appearance_details: 'Spricht mit einer Stimme wie eine rostige Türangel.'

# Charakter
char_pupils: 'äußerst fordernd, respektlos und ungeduldig.'
char_facade: 'Ein verkanntes, adliges Wesen („Sir“); ein Agent auf „Mission von nationaler Wichtigkeit“.'
char_motives: 'Albus Dumbledore finden.'
char_strength: 'Sprachgewandtheit (wenn auch vulgär), Hartnäckigkeit, Frechheit.'
char_weakness: 'Kann keine Türklinken bedienen'
char_sensitivity: 'Fehlender Respekt gegenüber seinem Titel und seiner Mission.'
