...
# Äußere Erscheinung
appearance_features: 'Riesige Gestalt (doppelt so hoch, dreimal so breit wie ein Mann); wuchernder schwarzer Bart.'
appearance_behavior: 'Stampfende Gangart; donnernde Bassstimme; wirkt wild und einschüchternd.'
appearance_details: 'Mantel aus grob zusammengenähten Tierfellen; nutzt einen außergewöhnlich langen Zauberstab.'

# Charakter
char_pupils: 'sorgend'
char_facade: '—'
char_motives: 'Sicherheit der Erstklässler; Gehorsam gegenüber Dumbledore.'
char_strength: 'Physische Kraft; Fürsorge.'
char_weakness: 'Seine Vergangenheit (Anschuldigungen im Tagespropheten)'
char_sensitivity: '—'

# Einschätzung
estimate_instinct: 'Ella sieht in ihm eine akute Gefahr und einen potenziellen Mörder.'
estimate_rumors: 'Wird verdächtigt, Myrte Warren getötet zu haben; Dumbledore bürgt für ihn.'
estimate_quote: '„Erstklässler zu mir!“ <br> „Oh nein! Oh nein! Oh nein!“'
relation_status: '—'
observations: '—'
