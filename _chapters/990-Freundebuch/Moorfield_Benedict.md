---
layout: cvstudent
title: 'Moorfield, Benedict'
slug: cvs_moorfieldb

# Allgemeine Angaben
full_name: 'Benedict Moorfield'
birth_year: '1939'
death_year: '—'
school_year: '1950'
...
# Charakter
char_facade: 'Ein schüchterner, fast schon kauziger Junge mit einem Hang zur Flugtheorie.'
char_motives: 'Der Wunsch nach Wissen, und vielleicht die Hoffnung, durch Theorie seine Ängste zu kompensieren.'
char_strength: 'Fachwissen (Flugtheorie).'
char_weakness: 'Flugangst (Besenphobie), soziale Unsicherheit.'
char_sensitivity: '—'
char_status: '—'

# Einschätzung
estimate_instinct: 'Ella findet ihn merkwürdig.'
estimate_rumors: '—'
estimate_quote: '—'
relation_status: 'Bekannter'
observations: '—'
