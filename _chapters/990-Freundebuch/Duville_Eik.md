...
# Allgemeine Angaben
full_name: 'Eik Duville'
birth_year: '1939'
death_year: '—'
school_year: '1950'
house_name: 'Gryffindor'
house_slug: 'gryffindor'
wand: '—'
location: '—'
...
# Äußere Erscheinung
appearance_features: '—'
appearance_behavior: 'Aggressiv, laut, bedrohlich; verhält sich wie ein Halbstarker'
appearance_details: 'arrogant, wurde aber durch die Haussortierung gedemütigt'

# Charakter
char_facade: '—'
char_motives: 'Machtausübung über Schwächere.'
char_strength: '—'
char_weakness: '—'
char_sensitivity: 'Trennung von seinem Bruder; das Haus Gryffindor.'
char_status: 'Schikanierer in der Schülerschaft; Mitglied des Hauses Gryffindor (wider Willen).'

# Einschätzung
estimate_instinct: 'Abschaum; Ella genießt seine Demütigung durch den Hut.'
estimate_rumors: '—'
estimate_quote: '„Schlammblut!“'
relation_status: '—'
observations: '—'
...
<li>Er wurde zur Überraschung aller nach Gryffindor geschickt, was eine tiefe Demütigung für ihn darstellte [01.09.1950].</li>
